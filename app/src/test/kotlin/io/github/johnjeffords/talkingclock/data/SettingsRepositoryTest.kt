...
class SettingsRepositoryTest {
    ...
    fun `defaults match the documented product defaults`() = runTest {
        ...
        assertEquals("Game style", s.timerScheduleName)
        assertEquals(15 * 60L, s.lastTimerDurationSeconds)
        assertEquals(0, s.stopwatchAnnounceEverySeconds)
    ...
    fun `settings round-trip`() = runTest {
        ...
        repo.setStopwatchAnnounceEvery(60)
        ...
        assertEquals(60, s.stopwatchAnnounceEverySeconds)
